...
class LoginScreenController extends GetxController {
  ...
  Future<void> callSignInAPI(
    ...
    var apiResultFromNetwork = getAPIResultFromNetworkWithoutBase<LoginResponseModel?>(networkResult,
        (e) => LoginResponseModel.fromJson(e));
    ...
    if (loginAPIResult.value.apiResultType == APIResultType.success) {
      // logger.i(loginAPIResult.value.result);
        await PreferenceStorage.putObject(AppString.loginResponseModelKey, loginAPIResult.value.result!);
    ...
    if (loginAPIResult.value.apiResultType != APIResultType.success) {
      AppUtils.showSnackBar(
          message: loginAPIResult.value.message ?? '',
          isSuccess: false);
    }
  }
