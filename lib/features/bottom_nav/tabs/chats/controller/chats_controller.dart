...
class ChatsController extends GetxController {
  ...
  void onMessageSend() {
    ...
    final newMessage = ChatMessageResponseModel(
      ...
      message:
          'This is a simulated response for the query: "${chatTextEditingController.text}". In a real application, this would be replaced with an actual response from the backend or AI service.',
    );
